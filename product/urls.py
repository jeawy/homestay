...
from product.views_imgs import ImgAnonymousView, ProductImgView
app_name = "product"
urlpatterns = [
    # 礼品管理
    ...
    url(r'^img/$', csrf_exempt(ProductImgView.as_view()), name='img'),
    url(r'^imganonymous/$', csrf_exempt(ImgAnonymousView.as_view()), name='imganonymous'),
