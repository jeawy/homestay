            ...
            try:
                ...
                try:
                    ...
                    if verifycode_instance.code == verifycode:
                        try:
                            user = User(name=name, email=user_email, date=timezone.now(), password=pwd_1,
                                        is_active=True)
                            ...
                            t_send_email = threading.Thread(target=send_email,
                                                            args=[Subject, email_content, settings.SUPPORTOR_EMAIL])
                            t_send_email.start()
